...
- [tokenContracts](https://docs.walletconnect.com/2.0/web3modal/options#tokencontracts-optional)
...
- [enableNetworkView](https://docs.walletconnect.com/2.0/web3modal/options#enablenetworkview-optional)
- [enableAccountView](https://docs.walletconnect.com/2.0/web3modal/options#enableaccountview-optional)
- [standaloneChains](https://docs.walletconnect.com/2.0/web3modal/options#standalonechains-optional)